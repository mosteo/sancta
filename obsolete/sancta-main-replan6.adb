...
--  steadily forward and grows...

--  Furthermore, this example investigates the case in which not all tasks
--  are completed. When remaining reaches 50, we bail out.

procedure Sancta.Main.Replan6 is
   ...
   begin
      ...
      elsif Remain.Length <= Remain_Threshold then
         return 0.0;
      end if;
