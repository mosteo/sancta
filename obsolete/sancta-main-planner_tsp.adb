with Sancta.Assigners.Optimal_Tsp;
with Sancta.Config;
...
procedure Sancta.Main.Planner_Tsp is
   ...
   Ass    : Assigners.Optimal_Tsp.Object;
...
--   Enable_Section (Trace.Get_Default_Tracer.all, Sancta.Network.Layer.Udp.Log_Section);
   ...
   --  Config planner
   This.Set_Configuration (Assigner  => Ass,
                           Criterion => Sancta.Totalsum);
   This.Add_Method (Methods.Explore_Segment_Expansion.Object'(Sancta.Method.Object
                                                              with null record));

   Log ("TSP planner ready.", Informative);
...
exception
   when E : others =>
      Log ("Planner_TSP [Main]: " & Report (E), Error);
      Shutdown;


end Sancta.Main.Planner_Tsp;
