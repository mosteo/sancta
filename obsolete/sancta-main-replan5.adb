...
--  are completed. When remaining reaches 10, we bail out.

procedure Sancta.Main.Replan5 is
   ...
   Xwidth : constant Float := 10.0;
   Ywidth : constant Float := 10.0;
