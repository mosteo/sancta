...
procedure Sancta.Main.Compare1 is
   ...
   Iterations : constant := 10; -- #repetitions for average a single experiment.
   Valid_Iterations : Natural;
...
begin
   ...
   for S in Lateral .. Lateral loop -- #Starting poses
      N := Nmin;
      loop -- #Agents
         T := Tmin;
         loop -- #Tasks
            ...
            for I in 1 .. Iterations loop
               begin
                  ...
                  declare
                     Optimal_Cost : constant Sancta.Costs := Sancta.Costs.Get_Optimal_Cost (Agents,
                                                                                        Tasks);
               ...
               exception
                  when E : Agpl.Optimization.Concorde.No_Solution =>
                     Log (Report (E), Warning);
                     Log ("NO SOLUTION FOUND, SKIPPING ITERATION", Warning);
                  when E : others =>
                     Log ("ERROR: " & Report (E), Error);
                     raise;
               end;
            end loop; -- Averaging
            ...
            Put_Line (Avg_Result,
                      ...
                      N'Img & " " &
                      T'Img & " " &
                      Sancta.Costs'Image (Acum_Optimal / Sancta.Costs (Valid_Iterations)) &
                      Sancta.Costs'Image (Acum_Trading /Sancta.Costs (Valid_Iterations)) &
