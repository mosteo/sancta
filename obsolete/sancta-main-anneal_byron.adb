...
procedure Sancta.Main.Anneal_Byron is
...
--     Sancta.Plan.Print_Tree_Summary (Plan);
   ...
   Sol.Add_Mutation (Sancta.Mutable_Assignment.Do_Heuristic_All'Access,
                     Sancta.Mutable_Assignment.Undo_Heuristic_All'Access);

   --  Debug call:
   Sol.Set_Assignment (Sol.To_Assignment, Sancta.Minimax);
