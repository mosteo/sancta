...
--  steadily forward and grows in width and height

procedure Sancta.Main.Replan4 is

   Failed_Iteration : exception;
      ...
      begin
         ...
         begin
            ...
            if Remain.Length = 0 then
               ...
               begin
                  for Attempts in 1 .. 3 loop
                     begin
                        return Acum + Cost_TSP (New_Current,
                                                Jobs_B,
                                                Rem_B);
                     exception
                        when Agpl.Optimization.Concorde.No_Solution =>
                           null; -- We'll reattempt
                     end;
                  end loop;
                  raise Failed_Iteration;
               end;
            end if;
         end;
      end;
...
begin
   ...
   for Repeats in 1 .. 100 loop
      ...
      loop  --  Attempt until succesful run happens...
      ...
      --  Create the array of tasks:
         ...
         begin
            for I in 1 .. Initial_Tasks + Additional_Tasks + 1 loop
               ...
               begin
                  ...
                  if I <= Initial_Tasks then
                     ...
                     Put_Line ("XBase: " & XBase'Img);
                     Put_Line ("XWidth:" & XWidth'Img);
            ...
            exit; -- Always exit inner loop if no exception
         exception
            when Failed_Iteration =>
               Put_Line ("FAILED ITERATION, REATTEMPTING");
               null; -- Failed iteration, we'll reattempt.
         end;
      end loop;
