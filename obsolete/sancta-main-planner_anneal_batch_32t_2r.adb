...
procedure Sancta.Main.Planner_Anneal_Batch_32T_2R is
   ...
   begin
      declare
         E : array (1 .. 2) of Tasks.Choose_Entry_Point.Object :=
               (others =>
      ...
      begin
         R.Reset (0);
         for I in 1 .. 16 loop
            S (I) := Tasks.Explore_Segment.Create (( -6.0 + Types.Real (R.Uniform), X, 0.0),
                                                   (-75.0, X, 0.0));
            S (I + 16) := Tasks.Explore_Segment.Create (( 6.0 - Types.Real (R.Uniform), X, 0.0),
                                                        (75.0, X, 0.0));
...
end Sancta.Main.Planner_Anneal_Batch_32t_2r;
