with Agpl.Trace,
     ...
     Sancta.Gtk.Ctree_Node_Status,

     Sancta.Component.Include_Gtk,
...
procedure CTree_Node_Gtk is
begin
   Log (Command_Name & " starting...", Always);

   Sancta.Ctree.Component.Console.Register;
   Sancta.Ctree.Components.Register;
   Sancta.Gtk.Ctree_Node_Status.Ctree_Node_Status_To_Widget.Register;
   Sancta.Component.Include_Gtk.Register;
