...
package body Sancta.Mutable_Assignment is
   ...
   function To_String is new Conversions.Fixed_To_Str (Sancta.Costs);
   ...
   procedure Add_Agent (This : in out Object; A : in Sancta.Agent.Object'Class) is
   begin
...
--      This.Set_Assignment (This.To_Assignment, This.Context.Ref.Criterion);
   ...
   is
      ...
      A : Sancta.Assignment.Object := This.To_Assignment;
   begin
      U.Ass         := A;
...
--         New_Assignment.Print_Assignment;
   ...
   procedure Reevaluate_Agent_Cost (This  : in out Object;
                                    ...
                                    Cost  :    out Costs)
   is
      C     : Sancta.Cost_Cache.Object'Class renames This.Context.Ref.Costs.Ref.all;
      Total : Costs := 0.0;
...
--                Always, Detail_Section);
   ...
   is
      ...
      begin
         ...
         while Has_Element (J) loop
            if This.Context.Ref.Plan.Contains (Element (J).Get_Id) and then
              not Sancta.Plan_Node.Get_Finished (This.Context.Ref.Plan.Get_Node
                                              (Element (J).Get_Id))
            then
               declare
                  C : aliased Task_Context;
                  function Next_Id (K : Task_Lists.Cursor) return Sancta.Tasks.Task_Id
                  is
                  ...
                  begin
                     if not Has_Element (Nx) then
                        ...
                        not Sancta.Plan_Node.Get_Finished
      ...
      procedure Remove_Agent_Tasks (I : Sancta.Agent.Containers.Lists.Cursor) is
         use Sancta.Agent.Containers.Lists;
         use Sancta.Tasks.Containers.Lists;
         A : constant Sancta.Agent.Object'Class  := Element (I);
   ...
   begin
      ...
      declare
         Agents : constant Sancta.Agent.Containers.Lists.List := Ass.Get_Agents;
      begin
         Sancta.Agent.Containers.Lists.Iterate (Agents, Remove_Agent_Tasks'Access);
      end;
...
--              Log (Sancta.Tasks.Maps.First_Element (Pending_Tasks).To_String, Always);
      ...
      declare
         Agents : constant Sancta.Agent.Containers.Lists.List := New_Ass.Get_Agents;
      begin
   ...
   function Task_Key (Id : in Sancta.Tasks.Task_Id) return Solution_Context_Key is
   begin
   ...
   function To_Assignment   (This : in Object) return Sancta.Assignment.Object is
...
--      This.Debug_Dump_Contexts;
   ...
   function Evaluate_Cost_Inserting
     (This                : in Object;
      ...
      New_Owner           : in Agent_Id) return Sancta.Costs
   is
   ...
   begin
      ...
      if Plus_1 = Sancta.Infinite or else Plus_2 = Sancta.Infinite then
         ...
         return Criteria.Evaluate (This.Context.Ref.Criterion,
   ...
   exception
      when E : others =>
         Log ("Evaluate_Cost_Inserting [Plus1/Plus2/Minus]: " &
              ...
              Criteria.Image (Minus), Error, Log_Section);
