...
package body Sancta.Assignment.Utils is
   ...
   procedure Concatenate (Dst : in out Object; Src : Object) is
      ...
      procedure Do_It (I : Agent_Lists.Cursor) is
         Ag_Src : constant Sancta.Agent.Object'Class := Agent_Lists.Element (I);
      begin
         if Dst.Contains (Ag_Src.Get_Name) then
            declare
               Ag_Dst : Sancta.Agent.Object'Class := Dst.Get_Agent (Ag_Src.Get_Name);
