...
with Agpl.Containers.Bags; pragma Elaborate_All (Agpl.Containers.Bags);
with Sancta.Agent.Containers;
with Sancta.Assignment;
with Sancta.Cost_Cache;
private with Sancta.Cost_Cache.Handle;
...
package Sancta.Mutable_Assignment is
   ...
   Log_Section    : constant String := "Sancta.mutable_assignment";
   Detail_Section : constant String := "Sancta.mutable_assignment.detail";
   ...
   procedure Add_Agent (This : in out Object; A : in Sancta.Agent.Object'class);
   ...
   function To_Assignment   (This : in Object) return Sancta.Assignment.Object;
...
private
   ...
   package Solution_Context_Bags is new Agpl.Containers.Bags (Solution_Context_Key,
                                                  Bag_Context);
   ...
   type Task_Context is new Solution_Context with record
      Job             : Sancta.Tasks.Task_Id; -- The task proper.
      Prev, Next      : Sancta.Tasks.Task_Id := Sancta.Tasks.No_Task;
   ...
   type Or_Context is new Solution_Context with record
      Node   : Sancta.Plan.Subplan;
      Branch : Sancta.Plan.Subplan;
   end record;
   ...
   package Undo_Move_Vectors is
     new Agpl.Containers.Naked_Vectors (Undo_Move_Task_Info, 2);
      ...
      case Kind is
         ...
         when From_Scratch =>
            Ass : Assignment.Object :=
                    Assignment.Object (Assignment.Empty_Object);
         ...
         when Move_Task =>
            ...
            --  tail to head
         when Switch_Or_Node =>
            Actived_Or_Branch : Sancta.Plan.Subplan := null;
   ...
   function Task_Key (Id : in Sancta.Tasks.Task_Id) return Solution_Context_Key;
