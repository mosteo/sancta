...
--  This file should be used with almacen.* running in Player.
...
procedure Sancta.Pursuit.Main2 is
...
begin
   ...
   declare
      Target     : Tasks.Pursuit.Object :=
                     Tasks.Pursuit.Create ((7.0, -4.0, 1.57), Wait => True);
