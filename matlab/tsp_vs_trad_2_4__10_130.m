...
num_teams = 3;
team_rows = 13; % the number of data rows in each team size
mode_rows = team_rows * num_teams; % the number of data rows in each starting mode

% Read the contents...

[mode, bots, tasks, optimal_cost, trading_cost, ratio] = textread ('../results/tsp-vs-trad-2-4--10-130.txt', '%s %d %d %f %f %f');
